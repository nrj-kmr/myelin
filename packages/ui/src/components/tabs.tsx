...
const tabsListVariants = cva(
  "group/tabs-list inline-flex group-data-vertical/tabs:flex-col justify-center items-center p-1 w-fit group-data-horizontal/tabs:h-10 group-data-vertical/tabs:h-fit text-muted-foreground",
  {
    variants: {
      variant: {
        default: "bg-muted",

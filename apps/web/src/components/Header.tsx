      ...
      <div className='flex justify-between items-center mx-auto px-6 max-w-7xl h-20'>
        ...
        <div className='hidden md:flex items-center gap-3'>
          ...
          {!isLoaded ? (
            ...
            <Link
              href='/signin'
              className='inline-flex items-center gap-2 bg-primary/10 hover:bg-primary/20 px-5 py-2 border border-primary/20 rounded-md font-mono text-primary-foreground text-xs uppercase tracking-widest transition-all hover:-translate-y-0.5'
            >
              Sign In
            </Link>
          )}
